...
class SegmentationHead_earlyfusion(nn.Module):
    def __init__(self, mimo_layer, channels, blocks, segmentation_head, radar_input, camera_input, fusion):
        super(SegmentationHead_earlyfusion, self).__init__()
        ...
        #####################################################
        ########### SEGMENTATION WITH EARLY FUSION ##########
        #####################################################
